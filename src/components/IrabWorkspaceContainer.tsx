...
import IrabCheatSheet from "@/components/IrabCheatSheet";
import FreeTextIrabInput from "@/components/FreeTextIrabInput";
import IrabReconstruction from "@/components/IrabReconstruction";
...
export default function IrabWorkspaceContainer({ sentences }: { sentences: SentenceAnalysis[] }) {
