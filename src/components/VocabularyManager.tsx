...
interface LookupResponse {
  ...
  aiAssisted: boolean;
  camelCandidates: EnrichCandidate[];
}
...
export default function VocabularyManager({ items }: { items: VocabularyCardDTO[] }) {
  ...
  const [enrichCandidates, setEnrichCandidates] = useState<EnrichCandidate[] | null>(null);
   ...
   * deterministic). See src/lib/vocabulary-lookup.ts for why meaning/
  ...
  function applyCandidate(candidate: EnrichCandidate) {
