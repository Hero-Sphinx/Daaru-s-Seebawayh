 ...
 * "comprehension" needs an LLM (src/server/services/library/quizComprehension.ts), and
 ...
 * the sentence_meaning_match book quiz subtype (src/server/services/library/quizMeaningMatch.ts).
 */
 ...
 * (src/helpers/irab/freeTextParser.ts), so a question is only produced when
