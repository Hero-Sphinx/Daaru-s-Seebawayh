...
import { caseSignFor, diptoteReason, finalMark, formDefiniteness, nounEnding, type EndingInfo } from "./case-ending";
...
import { analyzeVerb, type Governor, type SubjectRoleName } from "./verb-irab";
