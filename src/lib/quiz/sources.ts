...
import { QADT_POS_TAGS } from "@/lib/quran/tagset";
import { ASPECT_LABELS, CASE_LABELS, posLabel, verbFormLabel } from "./answer-labels";
import type { DistractorContext } from "./template-engine";
import type { QuizItem } from "./template-types";
