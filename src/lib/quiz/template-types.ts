 ...
 * are authored as data (src/lib/quiz/templates.ts -> seeded into the DB);
 * src/lib/quiz/template-engine.ts interprets them generically — adding a
...
/** One quizzable fact, from a source loader (src/lib/quiz/sources.ts). All values are display-ready strings. */
