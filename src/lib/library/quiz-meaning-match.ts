 ...
 * selectSentencesForMeaningMatch in src/lib/quiz/book-generate.ts); only
 * the translation text itself comes from Gemini — translation isn't a
 * grammar claim, same line drawn for src/lib/irab/translate.ts and
 * src/lib/vocabulary-lookup.ts. Every question this produces must be
 ...
 * — same reasoning as the PDF OCR fix in src/lib/library/extract-pdf.ts:
...
import type { SelectedSentence } from "@/lib/quiz/book-generate";
