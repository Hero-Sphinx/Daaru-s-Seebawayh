...
import { generateStructuredFromImage, GeminiNotConfiguredError, GeminiQuotaExhaustedError, isGeminiTimeout } from "@/lib/gemini-client";
 ...
 * already assumes (src/lib/irab/free-text-parser.ts).
 */
